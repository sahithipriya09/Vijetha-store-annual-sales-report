# Vijetha-Store-Annual-Sales-Report (Interactive Dashboard using MS Excel)
## Project Objective
The Vijetha Store wants to create an annual sales report for 2024. So that, the owner of the Vijetha store can understand their customers and grow more sales in 2025.
## Dataset used
-	<a href=https://github.com/sahithipriya09/Vijetha-store-annual-sales-report/blob/main/Vijetha%20Store%20Annual%20sales%20report.xlsx>Vijetha store dataset
## Questions (KPIs)
...
## Dashboard
- !screenshot <a href=https://github.com/sahithipriya09/Vijetha-store-annual-sales-report/blob/main/Screenshot%202025-11-17%20184757.png>
